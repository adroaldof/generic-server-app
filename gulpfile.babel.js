...
gulp.task('help', () => {
    ...
    plugins.util.log('================================================================================');
    plugins.util.log('| gulp serve       | npm run serve       | Run local server with live reload');
    plugins.util.log('| gulp full-serve  | npm run full-serve  | Run test, documentation and server');
    plugins.util.log('| gulp test        | npm run test        | Run tests and generate `coverage`');
    plugins.util.log('| gulp lint        | npm run lint        | Lint JS files (JSHint and JSCS)');
    plugins.util.log('| gulp documentate | npm run documentate | Generate documentation at `docs`');
    plugins.util.log('| gulp clean       | npm run clean       | Clean `docs`, `coverage` and `lib`');
    plugins.util.log('| gulp pre         | npm run pre         | Git Tag pre release (E.g. 0.0.0-1)');
    plugins.util.log('| gulp patch       | npm run patch       | Git Tag patch release (E.g. 0.0.1)');
    plugins.util.log('| gulp minor       | npm run minor       | Git Tag minor release (E.g. 0.1.0)');
    plugins.util.log('| gulp major       | npm run major       | Git Tag major release (E.g. 0.1.0)');
    plugins.util.log('| gulp help        | npm run help        | Show this help options');
    plugins.util.log('================================================================================');
});
